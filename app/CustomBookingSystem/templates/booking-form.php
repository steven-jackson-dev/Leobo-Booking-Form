                        ...
                        <div class="form-section dates-section">
                            ...
                            <div class="date-input-wrapper">
                                <div class="date-picker-container">
                                    <!-- Date Picker and Info Container -->
                                                ...
                                                <div class="dual-calendar-container">
                                                    ...
                                                    <div class="calendar-month" id="calendar-month-1">
                                                        <div class="calendar-header">
                                                            ...
                                                            <div class="calendar-title" id="calendar-title-1">January 2024</div>
                                                        ...
                                                        <div class="calendar-body">
                                                            ...
                                                            <div class="calendar-days" id="calendar-days-1">
                                                    ...
                                                    <div class="calendar-month" id="calendar-month-2">
                                                        <div class="calendar-header">
                                                            <div class="calendar-spacer"></div>
                                                            <div class="calendar-title" id="calendar-title-2">February 2024</div>
                                                        ...
                                                        <div class="calendar-body">
                                                            ...
                                                            <div class="calendar-days" id="calendar-days-2">
                                                                <!-- Days will be generated by JavaScript -->
                                                            </div>
                                                        </div>
                                                    </div>
